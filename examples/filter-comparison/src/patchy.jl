...
function compute_patchy_constants(vₚ_sat1::FloatOrMat{T}, ρ_sat1::FloatOrMat{T}, ϕ::FloatOrMat{T}, d::Tuple{T, T};
...
function Patchy(sat2::FloatOrMat{T}, vₚ_sat1::FloatOrMat{T}, ρ_sat1::FloatOrMat{T}, ϕ::FloatOrMat{T}, d::Tuple{T, T};
